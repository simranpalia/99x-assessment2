...
using Constants = _99xAssessment2.Utils.Constants;
    ...
    public class AccountController : BaseController
    {
        ...
        public ActionResult Login(string returnUrl)
        {
            ...
            if (Request.IsAuthenticated)
            {
                ...
                if (userRoles.Any())
                {
                    if (userRoles.Contains(Constants.RoleSuperUser))
                    {
        ...
        public ActionResult AddSuperAdminUser(string userName)
        {
        ...
        private IdentityResult SetupUser(string userName, string role)
        {
            var user = new ApplicationUser { UserName = userName, Email = userName };
            var result = UserManager.Create(user, _99XAppConfig.SuperAdminPwd);
            ...
            DAL.AddOrUpdateUser(new User
            {
                ...
                Username = userName,
                Password = SecurityUtils.Encrypt(_99XAppConfig.SuperAdminPwd)
            });
            return result;
        }
